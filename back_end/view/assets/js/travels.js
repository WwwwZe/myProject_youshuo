$(function () {
    ...
    var params
    if(urlArr.length==3) {
        params={pageSize:5,type:'type1',id:urlArr[urlArr.length-1]}
    }else {
        params={pageSize:5}
    }
        ...
        window.pagObj = $('.pagination').twbsPagination({
            ...
            onPageClick: function (event, page) {
              $.ajax({ 
                url:"/getPageContent",
                type:"get",
                data: urlArr.length==3?{pageNum:page,pageSize:5,type:'type1',id:urlArr[urlArr.length-1]}:{pageNum:page,pageSize:5},
                dataType:"json",
                success:function(dt){
